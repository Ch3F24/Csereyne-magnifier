document.addEventListener("DOMContentLoaded", () => {
    ...
    setSharpSpotPosition(image.clientWidth / 2, image.clientHeight / 2);
    sharpSpot.style.visibility = 'visible';
    ...
    function zooming(event) {
        ...
        setSharpSpotPosition(offsetX, offsetY);
    };

    function setSharpSpotPosition(offsetX, offsetY) {
    ...
    slides.forEach((slide, index) => {
        slide.addEventListener('click', () => {
            ...
            if(activeSource) {
                ...
                const imagePath = 'images/' + activeSource;
                image.src = imagePath;
                sharpSpot.style.backgroundImage = `url('${imagePath}')`;
